...
const SocialProofSection = () => {
  return (
    <section className="py-20 bg-background relative overflow-hidden">
      {/* Clean background */}
      <div className="absolute inset-0 bg-info-section-bg/50"></div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        <ScrollReveal>
          <div className="text-center mb-16">
            ...
            <div className="flex items-center justify-center gap-1 p-4 bg-white/80 backdrop-blur-md rounded-full border border-white/20 inline-flex shadow-xl hover:scale-105 transition-all duration-500 ease-out">
              {[...Array(5)].map((_, i) => (
                <Star key={i} className="w-5 h-5 text-amber-400 fill-current" />
              ))}
              <span className="text-gray-700 ml-3 font-bold text-sm">4.9/5 - Mais de 10.000 consultas realizadas</span>
            </div>
          </div>
        </ScrollReveal>
